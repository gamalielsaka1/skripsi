...
<div class="login-box">  
    <img src="<?php echo base_url('adminlte2/dist/')?>img/inspira.png" width="80%" height="80%" style="display:block; margin: auto"; class="img" alt="User Image">
  <div class="login-logo">
    <a href="<?php echo base_url('adminlte2/')?>index2.html"><b>SPK</b> TOPSIS </a>
  </div>
  <!-- /.login-logo -->
